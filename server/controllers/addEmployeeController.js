...
const addEmployeeController = (req,res) => {
    ...
    const employeeData = new employeeSchema({name:name,email:email,username:username,type:type,doj:doj,mobile:mobile,password:password,gender:gender,documents:documents,created_at:new Date(),status:'absent'});
