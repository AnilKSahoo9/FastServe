...
const parcelController = (req,res) => {
    ...
    let idP = uuidv4();
    new parcelSchema({_id:idP,items:items,totalAmount:totalAmount,billerName:billerName,billStatus:billStatus,orderStatus:orderStatus,required_time:null}).save();
